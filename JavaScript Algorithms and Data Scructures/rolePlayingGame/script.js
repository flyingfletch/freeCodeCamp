...
// establishing variable constants
...
// weapons array to establish weapons
const weapons = [
    {name: "stick", power: 5},
...
// monsters array to establish monsters
const monsters = [
...
// location array to establish game locations
const locations = [
...
// updates button text and location text depending on location using the location array
...
function getMonsterAttackValue(level) {
    ...
    console.log(hit);
    // ternary operator - acts like if else statement
    return hit > 0 ? hit : 0;
}
